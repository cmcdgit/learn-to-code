export const cPlusPlusQuestions = [
    ...
    },
    {
        ...
        "answer": "Destructors are called automatically when an object goes out of scope."
    },
    {
    ...
    {
        "question": "What does the keyword `virtual` indicate in a member function declaration?",
        "difficulty": "Medium",
        "options": [
    ...
    {
        "question": "Which of the following is the correct way to declare a pointer to a function that takes an int and returns an int?",
        "difficulty": "Hard",
        "options": [
            "int *func(int);",
            "int (*func)(int);",
    ...
    },
    {
        ...
        "answer": "The ability of a function or operator to work in more than one form."
    },
    {
        "question": "What will be the output of the following code?\n\n```cpp\nint main() {\n    int x = 5;\n    auto y = [&x]() { return ++x; };\n    std::cout << y();\n    return 0;\n}\n```",
        "difficulty": "Hard",
    ...
    {
        "question": "Which of the following is the correct syntax for a lambda function in C++?",
        "difficulty": "Hard",
        "options": [
            "[]() {}",
            "[] {}",
